#include "pmf_simulation/MotorController.h"

namespace pmf_simulation
{

    MotorController::MotorController(ros::NodeHandle n, ros::NodeHandle pn, const std::string &name) : srv_(ros::NodeHandle(pn, name)),
                                                                                                       int_val_(0.0),
                                                                                                       target_(0.0),
                                                                                                       last_error_(0.0)
    {
